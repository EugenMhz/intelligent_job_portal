...
function ApplicantManagement({ selectedJob, jobs, applicants, onToggleShortlist, onNavigate }) {
      ...
      <div className="page-header" style={{ flexDirection: 'column', alignItems: 'stretch', gap: '16px' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
          ...
          <div style={{ display: 'flex', gap: '12px' }}>
            <button className="btn btn-secondary" onClick={() => alert('Job link copied to clipboard!')}>
              <svg className="sidebar-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor" style={{ width: '16px', height: '16px' }}>
                ...
                <div key={candidate.id} className="candidate-card">
                  ...
                  <div className="candidate-actions">
                    ...
                    <button 
                      ...
                      onClick={() => alert(`Initiating interview loop with ${candidate.name}`)}
                      style={{ padding: '8px 14px', width: '100%', fontSize: '13px' }}
                    >
                      Interview
                    </button>

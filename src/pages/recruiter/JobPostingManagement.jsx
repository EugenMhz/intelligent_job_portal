        ...
        <div className="flex flex-wrap gap-1.5">
          <button 
            ...
            className={`px-4 py-2 rounded-xl text-sm font-semibold transition-all cursor-pointer ${
              activeTab === 'create' ? 'bg-violet-50 text-violet-700' : 'text-slate-600 hover:bg-slate-50'
            }`}
          >
            Create New Posting
          </button>
          <button
            className={`px-4 py-2 rounded-xl text-sm font-semibold transition-all cursor-pointer flex items-center ${
              activeTab === 'active-postings' ? 'bg-violet-50 text-violet-700' : 'text-slate-600 hover:bg-slate-50'
            }`}

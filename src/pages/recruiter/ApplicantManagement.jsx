        ...
        <div className="lg:col-span-3 space-y-6">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-white border border-slate-200 shadow-sm rounded-2xl p-4">
            <div className="flex flex-wrap gap-1">
              <button
                className={`px-4 py-2 text-xs sm:text-sm font-semibold rounded-xl transition-all cursor-pointer ${activeTab === 'All' ? 'bg-violet-50 text-violet-700' : 'text-slate-600 hover:bg-slate-50'
                  }`}
              ...
              <button
                className={`px-4 py-2 text-xs sm:text-sm font-semibold rounded-xl transition-all cursor-pointer ${activeTab === 'Shortlisted' ? 'bg-violet-50 text-violet-700' : 'text-slate-600 hover:bg-slate-50'
                  }`}
              ...
              <button
                className={`px-4 py-2 text-xs sm:text-sm font-semibold rounded-xl transition-all cursor-pointer ${activeTab === 'Interviewing' ? 'bg-violet-50 text-violet-700' : 'text-slate-600 hover:bg-slate-50'
                  }`}
              ...
              filteredApplicants.map((candidate) => (
                ...
                >
                  ...
                  <div className="flex flex-col md:items-end justify-center shrink-0 min-w-[110px]">
                    ...
                    <span className={`text-sm font-extrabold mt-1 ${candidate.matchScore >= 90 ? 'text-emerald-600 font-black' : 'text-violet-600'
                      }`}>

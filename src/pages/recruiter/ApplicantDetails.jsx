...
function ApplicantDetails({ applicant, onUpdateStatus, onNavigate }) {
  ...
  const candidateDetails = {
    email: applicant.email || defaultDetails.email,
    phone: applicant.phone || defaultDetails.phone,
    education: applicant.education || defaultDetails.education,
    bio: applicant.bio || defaultDetails.bio,
    workHistory: applicant.workHistory && applicant.workHistory.length > 0 ? applicant.workHistory : defaultDetails.workHistory
  };

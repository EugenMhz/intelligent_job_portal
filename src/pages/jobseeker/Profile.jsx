          ...
          <div className="flex flex-col sm:flex-row justify-between items-center gap-3 pt-5 border-t border-slate-200 mt-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
              <button 
                ...
                className="w-full sm:w-auto bg-white border border-slate-200 text-slate-700 font-semibold rounded-xl px-5 py-2.5 hover:bg-slate-50 transition-colors cursor-pointer text-center"
              >
                Change Password
              </button>
              <button className="w-full sm:w-auto bg-violet-600 hover:bg-violet-700 text-white font-semibold rounded-xl px-6 py-2.5 transition-colors cursor-pointer text-center shadow-sm">
                Save changes
              </button>
            </div>
          </div>

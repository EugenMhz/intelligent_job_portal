...
const Signup = () => {
  ...
  const handleSignup = (e) => {
    ...
    if (activeTab === "seeker") {
      ...
      // In a real app, recruiters would go to recruiter dashboard. Let's redirect to home for now.
      navigate("/");
    }
  };
        ...
        <div className="bg-white rounded-2xl flex max-w-4xl w-full overflow-hidden shadow-md">
          ...
          <div className="w-96 p-10 border-l border-gray-100 flex flex-col justify-center">
            ...
            <form onSubmit={handleSignup} className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full bg-purple-600 hover:bg-purple-700 text-white font-semibold py-2.5 rounded-xl text-sm transition-colors cursor-pointer"
              >
                Sign Up
              </button>
            </form>
